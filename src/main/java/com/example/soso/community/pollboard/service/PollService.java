...
public interface PollService {
     ...
     * @return 생성된 게시글 ID
     */
    Long createPoll(PollCreateRequest request, String userId);
     ...
     * @return 투표 게시글 상세 정보
     */
    PollDetailResponse getPoll(Long postId, String userId);
     ...
     */
    PollCursorResponse getPollsByCursor(PollStatus status, com.example.soso.community.pollboard.dto.PollSortType sort, int size, String cursor, String userId);
     ...
     */
    void updatePoll(Long postId, PollUpdateRequest request, String userId);
     ...
     */
    void deletePoll(Long postId, String userId);
