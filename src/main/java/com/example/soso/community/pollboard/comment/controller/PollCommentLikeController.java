...
import com.example.soso.community.pollboard.comment.service.PollCommentLikeService;
 ...
 */
@Tag(name = "Poll Comment Like", description = "투표 게시판 댓글 좋아요 API")
@Slf4j
@RestController
@RequestMapping("/community/polls/{pollId}/comments/{commentId}/like")
@RequiredArgsConstructor
public class PollCommentLikeController {

    private final PollCommentLikeService commentLikeService;

    @Operation(
            operationId = "togglePollCommentLike",
            summary = "댓글 좋아요 토글",
            description = """
    ...
    @Operation(
            operationId = "getPollCommentLikeStatus",
