...
public class PollCommentLikeServiceImpl implements PollCommentLikeService {
    ...
    public boolean toggleLike(Long commentId, String userId) {
        PollComment comment = commentRepository.findById(commentId)
        ...
        return commentLikeRepository.findByCommentAndUser(comment, user)
                ...
                .orElseGet(() -> {
                    // 좋아요 추가
                    PollCommentLike newLike = PollCommentLike.create(comment, user);
